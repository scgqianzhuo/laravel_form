...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/skin/green/skin.css')}}" id="skin" />
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="{{url('student/index')}}" data-title="会员列表" href="javascript:;">会员列表</a></li>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="{{url('admin/index')}}"></iframe>
        </div>
    </div>
</section>
